...
Plugin URI:  https://keendevs.com/linkedin-company-updates/
...
LinkedIn Company Updates is free software created by <a href="https://keendevs.com">KeenDevs</a>: you can redistribute it and/or modify
		    ...
		    if ( $this->token_life ) {
				...
				if ( $array_updates ) {
					foreach ($array_updates as $update) {
						...
						update_option('test_share_', $update_share);
						...
						{
							$img = '<a target="_blank" href="' . $update_image_link . '"><img alt="" class="linkedin-update-image" src="https://suntuitiveglass.com/wp-content/uploads/2018/10/linkedin.jpg" /></a>';
						}
